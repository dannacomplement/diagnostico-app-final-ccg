...
const IA_CASOS_USO = [
  ...
  { value: 'generacion_contenido', label: 'Generacion de contenido', icon: '✍️' },
  { value: 'analisis_datos', label: 'Analisis de datos', icon: '📊' },
  { value: 'automatizacion', label: 'Automatizacion de tareas', icon: '⚙️' },
];

const INTERES_OPTIONS = [
  { value: 'alto' as const, label: 'Alto', desc: 'Es prioridad estrategica' },
  { value: 'medio' as const, label: 'Medio', desc: 'Interesa pero no es prioridad' },
  { value: 'bajo' as const, label: 'Bajo', desc: 'Poco interes por ahora' },
  { value: 'ninguno' as const, label: 'Ninguno', desc: 'No esta en el radar' },
];
...
const INVERSION_OPTIONS = [
  ...
  { value: 'mas_500k' as const, label: 'Mas de $500,000' },
  { value: 'no_sabe' as const, label: 'No lo se' },
];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div>
        ...
        <p className="text-muted" style={{ fontSize: '12px' }}>
          Nivel de conocimiento y adopcion de IA en la empresa.
        </p>
      </div>
      ...
      {ai.usaIAEnEmpresa && (
        <div className="bg-white rounded-xl border border-border/60 shadow-sm" style={{ padding: '24px' }}>
          <label className="font-semibold text-navy" style={{ fontSize: '13px', marginBottom: '12px', display: 'block' }}>
            ¿En que areas usa IA? (seleccione las que apliquen)
          </label>
      ...
      <div className="bg-white rounded-xl border border-border/60 shadow-sm" style={{ padding: '24px' }}>
        <label className="font-semibold text-navy" style={{ fontSize: '13px', marginBottom: '12px', display: 'block' }}>
          Nivel de interes en implementar IA
        </label>
      ...
      <div className="bg-white rounded-xl border border-border/60 shadow-sm" style={{ padding: '24px' }}>
        <label className="font-semibold text-navy" style={{ fontSize: '13px', marginBottom: '12px', display: 'block' }}>
          Inversion anual aproximada en tecnologia (MXN)
        </label>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
