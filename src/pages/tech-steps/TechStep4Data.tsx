...
const DATA_USAGE_OPTIONS = [
  { value: 'nunca' as const, icon: Circle, iconClassName: 'fill-error text-error', label: 'Nunca', desc: 'Sin datos' },
  { value: 'a_veces' as const, icon: Circle, iconClassName: 'fill-warn text-warn', label: 'A veces', desc: 'Ocasionalmente' },
  { value: 'frecuentemente' as const, icon: Circle, iconClassName: 'fill-success text-success', label: 'Frecuentemente', desc: 'Casi siempre' },
  { value: 'siempre' as const, icon: Rocket, iconClassName: 'text-accent', label: 'Siempre', desc: 'Data-driven' },
];
    ...
    <div className="card">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="flex items-center justify-between bg-pale/50 rounded-xl border border-border/30" style={{ padding: 'var(--sp-btn-a)' }}>
          <span className="text-ink font-medium" style={{ fontSize: 'var(--fs-13)' }}>¿Tiene KPIs definidos?</span>
          <button
        ...
        <div>
          <div className="flex items-center justify-between bg-pale/50 rounded-xl border border-border/30" style={{ padding: 'var(--sp-btn-a)', marginBottom: '12px' }}>
            <span className="text-ink font-medium" style={{ fontSize: 'var(--fs-13)' }}>¿Usa dashboards o Business Intelligence?</span>
            <button
        ...
        {/* Analitica avanzada */}
        <div className="flex items-center justify-between bg-pale/50 rounded-xl border border-border/30" style={{ padding: 'var(--sp-btn-a)' }}>
          <span className="text-ink font-medium" style={{ fontSize: 'var(--fs-13)' }}>¿Usa analítica avanzada o modelos predictivos?</span>
          <button
