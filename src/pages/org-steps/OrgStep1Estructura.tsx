...
export default function OrgStep1Estructura() {
  ...
  return (
    <div className="card">
      <h2 className="font-serif text-navy" style={{ fontSize: 'var(--fs-17)', marginBottom: '8px' }}>Estructura y Organigrama</h2>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="rounded-xl border border-border bg-pale" style={{ padding: '20px' }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-ink" style={{ fontSize: 'var(--fs-13)' }}>¿Tiene organigrama formal?</p>
              <p className="text-muted" style={{ fontSize: 'var(--fs-11)', marginTop: '2px' }}>Un documento que muestre la estructura jerárquica de la empresa</p>
            </div>
          ...
          {org.tieneOrganigrama && (
            <div className="flex items-center justify-between border-t border-border/40" style={{ marginTop: '14px', paddingTop: '14px' }}>
              <p className="font-medium text-ink" style={{ fontSize: 'var(--fs-12)' }}>¿Está actualizado?</p>
              <div className="flex" style={{ gap: '4px' }}>
                <button
                  type="button"
                  ...
                  style={{ padding: '4px 12px', borderRadius: '6px', fontSize: 'var(--fs-11)' }}
                >
                  Sí
                </button>
                <button
        ...
        <div className="rounded-xl border border-border bg-pale" style={{ padding: '20px' }}>
          <p className="font-medium text-ink" style={{ fontSize: 'var(--fs-13)', marginBottom: '4px' }}>¿Tiene descripciones de puesto documentadas?</p>
          <p className="text-muted" style={{ fontSize: 'var(--fs-11)', marginBottom: '12px' }}>Documentos formales que describan las funciones de cada posición</p>
        ...
        <div className="rounded-xl border border-border bg-pale" style={{ padding: '20px' }}>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-ink" style={{ fontSize: 'var(--fs-13)' }}>¿Tiene tabulador de sueldos?</p>
              <p className="text-muted" style={{ fontSize: 'var(--fs-11)', marginTop: '2px' }}>Tabla con rangos salariales por puesto o nivel</p>
            </div>
            <div className="flex" style={{ gap: '4px' }}>
              <button
                type="button"
        ...
        <div>
          ...
          <div className="flex items-center" style={{ gap: '8px' }}>
            ...
            <input
              ...
              placeholder="0"
              className="input-field"
              style={{ fontSize: 'var(--fs-13)', maxWidth: '220px' }}
            />
            <span className="text-muted" style={{ fontSize: 'var(--fs-11)' }}>MXN / mes</span>
          </div>
        </div>
      </div>
    </div>
